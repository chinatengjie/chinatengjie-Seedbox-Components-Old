...
if [[ $distro_codename = buster ]]; then
    wget https://raw.githubusercontent.com/chinatengjie/chinatengjie-Seedbox-Components-Old/main/Miscellaneous/BBR/5.10.0/tcp_bbrx.c
    kernel_ver=5.10.0
elif [[ $distro_codename = bullseye ]] ; then
    wget https://raw.githubusercontent.com/chinatengjie/chinatengjie-Seedbox-Components-Old/main/Miscellaneous/BBR/5.15.0/tcp_bbrx.c
    kernel_ver=5.15.0
fi
algo=bbrx
bbr_file=tcp_$algo
